...
const INDUSTRIAL_BRANCH = [
    ...
    createTieredImprovementRequest(
      ...
      'industrial',
      {
        ...
        productionOutputs: { super_alloys: 0.037 },
    ...
    createTieredImprovementRequest(
      ...
      'industrial',
      {
        ...
        build: 200,
        capacity: 2,
        sustainmentCost: { super_alloys: 3.5, plasma_fuel: 2.5, nano_machines: 1 },
...
const RESEARCH_BRANCH = [
     ...
     'research',
      {
       ...
       productionOutputs: { rare_gases: 0.024, genomes: 0.01 },
   ...
   createTieredImprovementRequest(
     ...
     'research',
     {
       ...
       build: 230,
       capacity: 2,
       sustainmentCost: { super_alloys: 2.5, rare_gases: 2.5, quantum_circuits: 1 },
     ...
     'research',
      {
       ...
       productionOutputs: { quantum_circuits: 0.048, sentient_cores: 0.014 },
   ...
   createTieredImprovementRequest(
     ...
     'research',
     {
       ...
       capacity: 6,
        ...
        productionOutputs: { rare_gases: 0.12, quantum_circuits: 0.055, sentient_cores: 0.02 },
...
const MILITARY_BRANCH = [
  ...
  createTieredImprovementRequest(
    ...
    'military',
    {
      ...
      productionOutputs: { super_alloys: 0.026, plasma_fuel: 0.03 },
  ...
  createTieredImprovementRequest(
    ...
    'military',
    {
      ...
      productionOutputs: { plasma_fuel: 0.058 },
  ...
  createTieredImprovementRequest(
    ...
    'military',
    {
      ...
      productionOutputs: { genomes: 0.045, psycho_implants: 0.03 },
  ...
  createTieredImprovementRequest(
    ...
    'military',
    {
      ...
      productionOutputs: { super_alloys: 0.125, nano_machines: 0.092 },
      modifiers: {
   ...
   createTieredImprovementRequest(
     ...
     'cultural',
     {
       ...
       capacity: 4,
        ...
        productionOutputs: { genomes: 0.072, psycho_implants: 0.018 },
       unityOutput: 0.55,
   ...
   createTieredImprovementRequest(
     ...
     'cultural',
     {
       ...
       capacity: 6,
        ...
        productionOutputs: { genomes: 0.055, psycho_implants: 0.11 },
       unityOutput: 1.1,
...
const SPIRITUAL_BRANCH = [
   ...
   createTieredImprovementRequest(
     ...
     'spiritual',
     {
       ...
       build: 160,
       capacity: 2,
       sustainmentCost: { biomass: 2.5, plasma_fuel: 1.5, ancient_relics: 1 },
   ...
   createTieredImprovementRequest(
     ...
     'spiritual',
     {
       ...
       capacity: 6,
        ...
        productionOutputs: { ancient_relics: 0.19, psycho_implants: 0.05, sentient_cores: 0.03 },
       unityOutput: 3.4,
...
const RESOURCE_BRANCH = [
   ...
   createTieredImprovementRequest(
     ...
     'resource',
     {
       ...
       build: 150,
       capacity: 2,
       sustainmentCost: { biomass: 2, genomes: 1 },
