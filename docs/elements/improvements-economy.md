...
### Industrial Branch
- Orbital Foundry Complex (T1): cost 100, build 240, capacity 2, sustain biomass 3 + solid_ice 2, produces super_alloys 8, industrial_output +0.02
- Asteroid Mining Operation (T1): cost 80, build 200, capacity 2, sustain solid_ice 2, produces rare_gases 5 + solid_ice 3
- Titan Forge Network (T2): cost 200, build 400, capacity 3, sustain biomass 5 + solid_ice 3, produces super_alloys 15, industrial_output +0.05
...
- Universal Data Archive (T1): cost 70, build 160, capacity 1, sustain solid_ice 2, research_speed +0.045
...
- Fortress World Designation (T2): cost 250, build 480, capacity 4, sustain super_alloys 6 + solid_ice 4, army_organization +8, supply_efficiency +0.10
...
- Diplomatic Enclave (T1): cost 60, build 140, capacity 1, sustain biomass 1 + solid_ice 1, empire_approval +1
...
### Economic Branch
- Interstellar Trade Hub (T1): cost 80, build 180, capacity 2, sustain solid_ice 2, trade_income +200, market_efficiency +0.02
- Strategic Supply Depot (T1): cost 70, build 160, capacity 1, sustain solid_ice 1, produces solid_ice 3, supply_efficiency +0.03
- Convergence Nexus (T2): cost 180, build 400, capacity 3, sustain solid_ice 4 + rare_gases 2, trade_income +500, market_efficiency +0.05
- Galactic Banking Consortium (T2): cost 160, build 360, capacity 3, sustain super_alloys 2 + solid_ice 3, trade_income +400, market_efficiency +0.04
