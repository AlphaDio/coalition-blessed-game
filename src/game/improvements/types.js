...
export const SUSTAINMENT_MAX_PRICE_MULTIPLIER = 2.0; // Willing to pay up to 2x market price
export const MARKET_SELL_PRICE_DISCOUNT = 0.95; // Sell at 95% of market price
