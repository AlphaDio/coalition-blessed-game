/**
 * Main UI Renderer for Coalition: The Blessed Game
 * 
 * This file orchestrates the terminal UI rendering using blessed.
 * For better maintainability, panel creation has been separated into panelFactory.js.
 * 
 * TABLE OF CONTENTS:
 * ─────────────────────────────────────────────────────────────────
 * Imports & Setup
 * Main Render Functions (exported)
 * - createUI() - Initialize UI
 * - renderLaws() - Render action panel
 * - renderActionPanel() - Render action menu
 * - renderEvent() - Render event display
 * - renderStats() - Render statistics
 * - renderStockpiles() - Render stockpiles
 * - renderTables() - Render all table views
 * - renderActiveFronts() - Render battle fronts
 * - renderActiveLaws() - Render law processes
 * - renderLog() - Render log box
 * - renderLogsWindow() - Render logs overlay
 * - renderCombinedInfo() - Render info panels (market, armies, etc.)
 * - renderAll() - Orchestrate all renders
 * 
 * Menu Builders
 * - buildMainMenuItems()
 * - buildLawMenuItems()
...
export function createUI() {
  ...
  // Create all panels using panelFactory
  ...
  // Disable input on display-only widgets
